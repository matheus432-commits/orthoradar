...
export const P01_ANALYSES: AnalysisDefinition[] = [
  ...
  },
  {
    ...
    valueType:       'SCALAR_MM',
    unit:            'MM',
    constraint:      { min: new Decimal('-10'), max: new Decimal('10'), minInclusive: true, maxInclusive: true },
    isRequired:      true,
  ...
  },
  {
    ...
    unit:            'PERCENT',
    constraint:      { min: new Decimal('0'), max: new Decimal('100'), minInclusive: true, maxInclusive: true },
    isRequired:      true,
  ...
  },
  {
    ...
    unit:            'DEGREES',
    constraint:      { min: new Decimal('70'), max: new Decimal('145'), minInclusive: true, maxInclusive: true },
    isRequired:      true,
  ...
  },
  {
    ...
    unit:            'RATIO',
    constraint:      { min: new Decimal('0'), max: new Decimal('3'), minInclusive: true, maxInclusive: true },
    isRequired:      true,
  ...
  },
  {
    ...
    valueType:       'SCALAR_MM',
    unit:            'MM',
    constraint:      { min: new Decimal('0'), max: new Decimal('10'), minInclusive: true, maxInclusive: true },
    isRequired:      true,
